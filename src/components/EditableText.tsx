  ...
  if (isEditing) {
    return (
      <input
        ...
        className={`${className} ring-2 ring-indigo-500 ring-opacity-50 transition-all duration-200 rounded px-1 py-0.5 min-h-[1.5rem] bg-transparent border-none outline-none`}
